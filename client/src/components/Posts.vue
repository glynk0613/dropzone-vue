      ...
      <div class="thumbnail">
        ...
        <div class="like-wrapper">
          <input
            ...
            :id="'chbox' + index"
            v-on:click="setLikeIt(index)"
            :checked="getLikeIt(index)"
          >
    ...
    <div class="col-xl-12">
      <nav aria-label="Page navigation example">
        <ul v-if="totalPages" class="pagination justify-content-center">
          ...
          <li
            :class="currentPage == pageNumber ? 'page-item active' : 'page-item'"
...
export default {
  props: ['uploadRes'],
  watch: {
    uploadRes: function (newVal, oldVal) {
      this.getPosts(1)
    }
  },
  data () {
